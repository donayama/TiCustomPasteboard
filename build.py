...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','jp.hsj.ticustompasteboard.js')
	...
	f = os.path.join(cwd,'Classes','JpHsjTicustompasteboardModuleAssets.mm')
	c = open(f).read()
	idx = c.find('return ')
	before = c[0:idx]
	after = """
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','jp.hsj.ticustompasteboard.js']
